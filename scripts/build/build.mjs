...
// Added: parse CLI args for the redirectCSS flag
const args = process.argv.slice(2);
const IS_REDIRECT_CSS = args.includes("--redirectCSS");
console.log(`[build.mjs] Redirect CSS mode: ${IS_REDIRECT_CSS ? "ENABLED" : "disabled"}`);

// Added: include IS_REDIRECT_CSS in defines
