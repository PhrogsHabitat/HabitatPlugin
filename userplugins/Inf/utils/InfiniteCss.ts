...
:root:not(.reduce-motion) .channelTextAreaContainer_d0696b:has(~ .base_b88801) {
    padding-top: 24px;
    transition-property: padding-top;
...
.empty__36d07, .emptyForum__36d07 {
    display: none;
}
...
.theme-light .theme-dark ::-webkit-scrollbar-track-piece {
    background:  hsla(265,40%,80%,0.3)!important;
}
.theme-light ::-webkit-scrollbar-track-piece {
    background:  hsla(265,60%,95%,0.3)!important;
...
.wrapper_c19a55.cozy_c19a55.zalgo_c19a55[aria-labelledby*="upload"] {
    background-color: rgba(210, 190, 255, 0.692) !important;
}
.cozy_c19a55 .repliedMessage_c19a55 {max-width: 100%;}
...
.habitat-main-bubble {
        ...
        box-shadow: 0 2px 10px rgba(180, 140, 255, 0.2);
        display: flex;
        justify-content: center;
        align-items: center;
        font-size: 20px;
...
.habitat-action-bubble {
        ...
        pointer-events: auto;
        box-shadow: 0 1px 5px rgba(180, 140, 255, 0.2);
        transition:
